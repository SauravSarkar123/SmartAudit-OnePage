      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 px-4">
          <div className="relative p-2 rounded-lg text-center hover:shadow-xl transition-shadow duration-300">
            ...
            <h4 className="text-xl font-bold mt-4 relative text-[#DFC03E]">Comprehensive Security Audits</h4>
          </div>
          <div className="relative p-2 rounded-lg text-center hover:shadow-xl transition-shadow duration-300">
            <div
              className="relative bg-cover bg-center bg-no-repeat h-64 rounded-lg"
            ...
            <h4 className="text-xl font-bold mt-4 relative  text-[#DFC03E]">Real-Time Monitoring and Incident Response</h4>
          </div>
          <div className="relative p-2 rounded-lg text-center hover:shadow-xl transition-shadow duration-300">
            <div
              className="relative bg-cover bg-center bg-no-repeat h-64 rounded-lg"
            ...
            <h4 className="text-xl font-bold mt-4 relative text-[#DFC03E] ">Advanced Threat Intelligence</h4>
          </div>
          <div className="relative p-2 rounded-lg text-center hover:shadow-xl transition-shadow duration-300">
            <div
              className="relative bg-cover bg-center bg-no-repeat h-64 rounded-lg"
            ...
            <h4 className="text-xl font-bold mt-4 relative text-[#DFC03E]">Decentralized and Resilient Security Infrastructure</h4>
          </div>
        </div>
      </div>
    </div>
