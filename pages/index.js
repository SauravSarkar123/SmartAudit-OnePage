...
const CardWithImageBackground = ({ image }) => {
  return (
    <div className="relative flex justify-center items-center">
      <div className="neon-card w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden bg-cover bg-center shadow-lg" style={{ backgroundImage: `url(${image})` }}>
...
const handleWhitepaperClick = () => {
  window.open('https://drive.google.com/file/d/11BuM2dQpIwzjztYjF7d5CpLWqTgmhU64/view?usp=sharing', '_blank');
};
    ...
    <>
      <div className="relative h-screen overflow-hidden bg-gradient-to-b from-gray-900 to-gray-800">
        ...
        <div id="home" className="absolute inset-0 flex flex-col h-full z-40">
          <Navbar className ="z-20 relative" logo="/Logo.png"  /> {/* Replace with your logo path */}
          <div className="flex flex-col md:flex-row items-center justify-between flex-grow text-blue-900 px-4 md:px-12 lg:px-24">
            <div className="w-full md:w-1/2 text-left mb-8 md:mb-0">
              ...
              <button className="Documents-btn" onClick={handleWhitepaperClick}>
